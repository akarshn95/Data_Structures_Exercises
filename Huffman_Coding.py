...
if __name__ == "__main__":
    ...
    # TEST CASE 2
    numbers = "12345671122334"

    print ("The size of the data is: {}\n".format(sys.getsizeof(numbers)))
    print ("The content of the data is: {}\n".format(numbers))

    encoded_data, tree = huffman_encoding(numbers)
    ...
    print ("The size of the data is: {}\n".format(sys.getsizeof(aaa)))
    print ("The content of the data is: {}\n".format(aaa))

    encoded_data, tree = huffman_encoding(aaa)
